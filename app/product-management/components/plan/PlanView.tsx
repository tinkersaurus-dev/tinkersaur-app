...
import { Button, Card, Empty } from '~/core/components/ui';
import { useSolutionStore } from '~/core/solution';
import { usePlanningVersionsQuery } from '~/product-management/queries/usePlanningQueries';
import {
  useUpdatePlanningPriorities,
  useExportPlanning,
} from '~/product-management/mutations/usePlanningMutations';
import type { PlanningVersion, VersionPriorityItem } from '~/core/entities/product-management/types/Planning';
import { calculateVersionPoints, countVersionStories } from '~/core/entities/product-management/types/Planning';
