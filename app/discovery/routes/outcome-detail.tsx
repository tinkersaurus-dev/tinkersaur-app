...
import { Button, Card, Modal, Empty, Tabs, Table, EditableSection, EditableField } from '~/core/components/ui';
import type { TableColumn } from '~/core/components/ui';
import { SOURCE_TYPES, type SourceTypeKey } from '~/core/entities/discovery/types/SourceType';
import { useOutcomeQuery, useIntakeSourceDetailsQuery } from '../queries';
import { useDeleteOutcome, useUpdateOutcome } from '../mutations';
import { loadOutcomeDetail } from '~/product-management/loaders';
import type { OutcomeDetailLoaderData } from '~/product-management/loaders';
import type { Route } from './+types/outcome-detail';
