...
import { getClassShapeData, getEnumerationShapeData, type Shape, type ClassShapeData, type EnumerationShapeData } from '~/core/entities/design-studio/types/Shape';
