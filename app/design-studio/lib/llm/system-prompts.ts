...
/**
 * Entity Relationship diagram system prompt
 * Uses Mermaid erDiagram syntax
 */
const ENTITY_RELATIONSHIP_SYSTEM_PROMPT = `You are an Entity Relationship diagram generator. Generate Mermaid erDiagram syntax based on user descriptions.
 ...
 */
const ENTITY_RELATIONSHIP_SUGGESTIONS_SYSTEM_PROMPT = `You are a database design and data modeling expert. Analyze the provided Mermaid ER diagram and suggest improvements for better data design.
 ...
 */
const ENTITY_RELATIONSHIP_APPLY_SUGGESTION_SYSTEM_PROMPT = `You are an ER diagram editor. Given an entity's current Mermaid representation and an improvement suggestion, return updated Mermaid erDiagram syntax that implements the suggestion.
