...
import type {
  ...
  DragData,
  ResizeData,
} from '../../lib/hooks/useInteractionState';
import { useCanvasPanning } from '../../lib/hooks/useCanvasPanning';
import { useCanvasLabelEditing } from '../../lib/hooks/useCanvasLabelEditing';
import { useCanvasSelection } from '../../lib/hooks/useCanvasSelection';
import { useConnectorDrawing } from '../../lib/hooks/useConnectorDrawing';
import { useConnectorInteraction } from '../../lib/hooks/useConnectorInteraction';
import { useShapeDragging } from '../../lib/hooks/useShapeDragging';
import { useShapeResizing } from '../../lib/hooks/useShapeResizing';
import { useShapeInteraction } from '../../lib/hooks/useShapeInteraction';
import { useCanvasKeyboardHandlers } from '../../lib/hooks/useCanvasKeyboardHandlers';
import { useCanvasContextMenu } from '../../lib/hooks/useCanvasContextMenu';
