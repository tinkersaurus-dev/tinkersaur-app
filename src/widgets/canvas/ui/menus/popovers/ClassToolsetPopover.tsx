/**
 * Class Diagram Toolset Popover Component
 *
 * Displays a popover with class diagram tools when the user right-clicks on the canvas.
 * Tools are organized by type with icon buttons.
 */

import { classToolGroups, type Tool } from '@/features/diagram-rendering/class/tools';
...
export function ClassToolsetPopover({
  x,
  y,
  canvasX,
  canvasY,
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-0">
        {classToolGroups.map((group, groupIndex) => (
          <div key={group.type}>
            {/* Tool row */}
            ...
            {groupIndex < classToolGroups.length - 1 && (
