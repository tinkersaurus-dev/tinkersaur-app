  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        ...
        <Button variant="primary" icon={<FiPlus />} onClick={onCreateClick}>
          Create
        </Button>
      </div>
