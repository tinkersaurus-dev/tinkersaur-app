...
export default [
  ...
  layout("layouts/MainLayout.tsx", [
    ...
    route("discovery/organize/use-cases", "../pages/discovery/organize/use-cases/page.tsx"),
    route("discovery/organize/use-cases/:useCaseId", "../pages/discovery/organize/use-cases/[useCaseId]/page.tsx", { id: "discovery-use-case-detail" }),
