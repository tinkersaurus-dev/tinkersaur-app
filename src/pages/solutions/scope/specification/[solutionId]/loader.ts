...
export interface SpecificationLoaderData {
  dehydratedState: ReturnType<typeof dehydrate>;
  solutionId: string;
}

/**
 * Load solution and its use cases for specification page
 * Prefetches queries that will be used by the page
 * Note: SSR prefetch may fail without auth token - client will refetch
 */
export async function loadSpecificationPage(solutionId: string): Promise<SpecificationLoaderData> {
