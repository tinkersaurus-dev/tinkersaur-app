import { z } from 'zod';
import { DiagramTypeSchema } from '@/entities/diagram';
import { InterfaceFidelitySchema } from '@/entities/interface';
import { ReferenceRefSchema } from '@/entities/reference';
import { RequirementRefSchema } from '@/entities/requirement-ref';
 ...
 * They are associated with a solution and can optionally be linked to specific use cases.
