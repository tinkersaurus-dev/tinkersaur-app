...
import type { DesignWork, CreateDesignWorkDto, DiagramRef, InterfaceRef, DocumentRef } from '@/entities/design-work';
import type { ReferenceRef } from '@/entities/reference';
import { designWorkApi } from '@/entities/design-work';
import type { ReorderItemDto } from '@/entities/design-work';
