import type { UseCase, CreateUseCaseDto, FindSimilarUseCasesRequest, SimilarUseCaseResult, MergeUseCasesRequest } from '../model/types';
import type { PaginatedResponse, UseCaseListParams } from '@/shared/api';
