...
import type { RequirementWithUseCase, RequirementType, RequirementStatus } from '@/entities/requirement';
...
export function RequirementItem({ requirement, folderNames = [] }: RequirementItemProps) {
  ...
  return (
    ...
    >
      ...
      >
        <Tag color={REQUIREMENT_TYPE_CONFIG[requirement.type as RequirementType].color}>{REQUIREMENT_TYPE_CONFIG[requirement.type as RequirementType].label}</Tag>
        <Tag color={REQUIREMENT_STATUS_CONFIG[requirement.status as RequirementStatus].color}>{REQUIREMENT_STATUS_CONFIG[requirement.status as RequirementStatus].label}</Tag>
