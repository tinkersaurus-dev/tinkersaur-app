...
import type { DrawingConnector } from '@/widgets/canvas/lib/hooks/useInteractionState';
import { ContextMenuWrapper } from '@/widgets/canvas/ui/menus/ContextMenuWrapper';
